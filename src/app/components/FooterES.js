        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="mb-8 md:mb-0">
            ...
            <p className="text-gray-400 max-w-xs mb-6">
              Clases personalizadas de inglés y español y servicios de traducción certificada en Bocas del Toro, Panamá.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">+507 6613-5652</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-blue-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-400">be.languages.pa@gmail.com</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-blue-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-400">Isla Colon, Bocas del Toro, Panamá</span>
              </li>
            </ul>
          </div>
        </div>
<div className="border-t border-gray-500 mt-8 pt-6 text-center text-sm">
        ...
        >
         &copy;  Sitio web hecho por <span className="font-semibold">Bocas Digital</span>
        </Link>
      </div>
