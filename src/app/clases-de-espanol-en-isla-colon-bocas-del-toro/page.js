...
const classTopics = [
    ...
    },
    {
        ...
        items: [
            ...
            "Términos de comida y restaurantes",
            "Frases de transporte",
            "Jerga local y expresiones",
    ...
    },
    {
        ...
        items: [
            "Tradiciones panameñas y etiqueta local",
            "Modismos panameños",
            "Festivales y cultura local",
            "Diferencias regionales",
            "Expresiones de lenguaje corporal",
        ],
        bg: "bg-blue-50/50 hover:bg-blue-50",
        border: "border-blue-100"
    },
    {
        title: "Práctica en el Mundo Real",
        icon: <Users className="w-6 h-6 text-blue-600" />,
        items: [
            "Visitas al mercado",
            "Juegos de roles en restaurantes",
            "Conversaciones en taxi/autobús",
            "Interacciones con vecinos",
            "Español por teléfono/SMS",
        ],
        bg: "bg-indigo-50/50 hover:bg-indigo-50",
        border: "border-indigo-100"
    },
    {
        ...
        items: [
            "Términos de surf/vela",
            "Citas y relaciones",
            "Alquiler/compra de propiedades",
  ...
  <div className="container mx-auto px-6 py-20 relative z-10">
    ...
    >
      ...
      <motion.div variants={fadeInUp} className="text-lg text-gray-700 mb-8">
        Aprende español con una instructora local certificada en el corazón del Caribe. Perfecto para expatriados, nómadas digitales y viajeros que quieren conectar con la cultura y la gente de Panamá.
      </motion.div>
                    ...
                    <div className="container mx-auto px-6 relative z-10">
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-600">
                                Mis clases están adaptadas a tus objetivos únicos y estilo de aprendizaje, cubriendo todo desde conversaciones esenciales hasta fundamentos de gramática.
                            </p>
                        </motion.div>
                ...
                <section id="pricing" className="py-20 relative overflow-hidden bg-gray-50">
                    ...
                    <div className="container mx-auto px-6 relative z-10">
                        ...
                        >
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold mb-4 leading-tight">
                                Precios <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">sencillos y transparentes</span>
                            </h2>
                            <p className="text-lg text-gray-600">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <ul className="text-gray-600 space-y-2">
                                    ...
                                    <li className="flex items-start">
                                        <span className="text-green-500 mr-2">•</span>
                                        Pueden aplicarse tarifas de transporte para clases presenciales fuera de Bocas Town
                                    </li>
                                    <li className="flex items-start">
                                        <span className="text-green-500 mr-2">•</span>
